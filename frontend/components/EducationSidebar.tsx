...
export function EducationSidebar() {
  ...
  return (
    <aside 
      className={`fixed right-6 bottom-6 z-40 w-80 transform transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}
    >
